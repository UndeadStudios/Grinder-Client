...
public final class Buffer extends Cacheable {
	...
	public static final int[] BIT_MASKS = {0, 0x1, 0x3, 0x7, 0xf, 0x1f, 0x3f, 0x7f, 0xff, 0x1ff, 0x3ff, 0x7ff, 0xfff, 0x1fff, 0x3fff,
	...
	public Buffer(int var1) {
		this.array = ByteArrayUtil.method862(var1);
		this.index = 0;
	}
	...
	public void writeLong(long value) {
		try {
			...
			Log.error("14395, " + 5 + ", " + value, runtimeexception);
	...
	public int readUnsignedShort() {
		this.index += 2; // L: 246
		return (this.array[this.index - 1] & 255) + ((this.array[this.index - 2] & 255) << 8); // L: 247
	}
	...
	public int readShortSmart() {
		int var1 = this.array[this.index] & 255; // L: 365
	...
	public void writeVariableLength(int var1) {
	...
	public void writeStringCp1252NullTerminated(String var1) {
		...
		if(var2 >= 0) {
			...
			this.index += OSTextInput.encodeStringCp1252(var1, 0, var1.length(), this.array, this.index);
	...
	public String readStringCp1252NullTerminated() {
		...
		return var2 == 0?"":OSTextInput.decodeStringCp1252(this.array, var1, var2);
	}
	public String readStringCp1252NullCircumfixed() {
		...
		if(var1 != 0) {
			...
			return var3 == 0?"":OSTextInput.decodeStringCp1252(this.array, var2, var3);
		}
	}
	...
	public String __aw_304() {
		...
		if(var1 != 0) {
			...
			int var2 = this.readVariableLength();
	...
	public int __bm_326() {
		this.index += 2;
		return ((this.array[this.index - 1] & 255) << 8)
				+ (this.array[this.index - 2] - 128 & 255);
	}
