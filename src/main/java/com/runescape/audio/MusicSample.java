...
public class MusicSample extends Node {
    ...
    MusicSample(byte[] musicData) {
        this.read(musicData);
    }

    void read(byte[] musicData) {
        Buffer buffer = new Buffer(musicData);
        ...
        for(int i = 0; i < length; ++i) {
            ...
            buffer.copyArray(var7, 0, var5);
            this.__m[i] = var7;
        }
    }
    float[] __g_175(int var1) {
        method2337(this.__m[var1]);
        method2338();
        ...
        for(var17 = 0; var17 < var14.field1453; ++var17) {
            ...
            float[] var19 = __cd_c;
            var18.method2473(var19, var4 >> 1, var15);
        }
    ...
    static void method2337(byte[] var0) {
        __cd_g = var0;
        __cd_l = 0;
        __cd_e = 0;
    }
    ...
    static void method2341(byte[] var0) {
        ...
        for(var1 = 0; var1 < 2; ++var1) {
            ...
            for(int var11 = 0; var11 < var5; ++var11) {
                var14[var11] = method87(var11, var10);
            }
    ...
    static boolean method2343(AbstractIndexCache cache) {
        if(!__cd_s) {
            byte[] var1 = cache.takeRecord(0, 0);
            if(var1 == null) {
                return false;
            }
    ...
    static MusicSample readMusicSample(AbstractIndexCache cache, int archive, int file) {
        if(!method2343(cache)) {
            cache.tryLoadRecord(archive, file);
            return null;
        } else {
            byte[] data = cache.takeRecord(archive, file);
            return data == null?null:new MusicSample(data);
        }
    }
