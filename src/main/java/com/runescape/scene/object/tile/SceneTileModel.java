...
public final class SceneTileModel {
    public static final int[] vertices_x = new int[6];
    public static final int[] vertices_y = new int[6];
    public static final int[] texture_vertices_x = new int[6];
    public static final int[] texture_vertices_y = new int[6];
    public static final int[] texture_vertices_z = new int[6];
    public static final int[] vertices_z = new int[6];
    ...
    public SceneTileModel(int yLoc, int j, int k, int l, int texture, int j1, int rotation, int l1, int i2, int j2, int k2, int l2, int i3, int j3, int k3, int l3, int i4, int xLoc, int l4) {
