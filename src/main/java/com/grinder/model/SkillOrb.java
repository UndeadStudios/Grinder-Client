...
public class SkillOrb {
    ...
    public void drawTooltip() {
        ...
        Rasterizer2D.drawBox(mouse_Y + 3, mouseY + 70, (int) ((percentProgress / 100.0) * 118), 14, ClientUtil.getProgressColor(percentProgress));
    ...
    private int startExp() {
        return currentLevel() == 1 ? 0 : ClientUtil.getXPForLevel(currentLevel() - 2);
    }

    private int requiredExp() {
        return ClientUtil.getXPForLevel(currentLevel() - 1);
    }
    ...
    private int remainderExp() {
        if (currentLevel() < 200) {
            ...
            return 2_147_112_018 - Client.instance.currentExp[skill];
        }
    }
    ...
    private int percentage() {
        ...
        try {
            if (currentLevel() < 200) {
                ...
                percent = (int) (((double) Client.instance.currentExp[skill] / 2_147_112_018) * 100);
            }
